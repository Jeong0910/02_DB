...
VALUES('900','홍길동','900324-1030536','hong_gd@or.kr',
'01015259295','D1','J7','S3', 4300000, 0.2,
200, SYSDATE, NULL, 'N');
...
-- 선택 안된 컬럼은 값이 NULL이 들어감(DEFAULT 존재시 DEFAULT 설정값으로 삽입됨)

INSERT INTO EMPLOYEE2 (EMP_ID, EMP_NAME, EMP_NO,
EMAIL, PHONE, DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY)
VALUES ('900','홍길동','900342-2345126','HONH_GD@OR.KR',
'01052842567','D1','J7','S3',4300000);

COMMIT; -- 홍길동 데이터 영구저장함
ROLLBACK; -- ROLLBACK 수행해봄
-- 영구저장되어 ROLLBACK해도 지워지지 않음.
...
INSERT INTO EMP_M02
VALUES(999,'곽두원', '560324-1234567', 'kwack_dw@or.kr',
'01098472521', 'D9', 'J4', 'S1', 9000000, 0.5, NULL,
SYSDATE, NULL, NULL);

SELECT * FROM EMP_M01; -- 23명
SELECT * FROM EMP_M02; -- 5명(기존4 + 1)
...
-- 테이블의 전체 행을 삭제하는 DDL
-- DELETE 보다 수행속도 더 빠름
-- ROLLBACK 을 통해 복구할 수 없음. CAUTION!
...
-- DELETE : 휴지통에 버리는 행위 (복구 가능)
-- TRUNCATE : 완전 삭제 (SHIFT DELETE)
