 ...
 *
 * DATE : 날짜 타입
 * BLOB : 대용량 이진 데이터 (4GB) - 파일 동영상
 * CLOB : 대용량 문자 데이터 (4GB) - 소설
 *
 * */

-- MEMBER 테이블 생성
CREATE TABLE MEMBER(
MEMBER_ID VARCHAR2(20), MEMBER_PWD VARCHAR2(20), MEMBER_NAME VARCHAR2(30),
MEMBER_SSN CHAR(14), ENROLL_DATE DATE DEFAULT SYSDATE);
...
INSERT INTO MEMBER VALUES('MEM01','123ABC','홍길동','900630-1030825', DEFAULT);
...
INSERT INTO MEMBER VALUES('MEM02','123ABD','김영희','870425-2030917', SYSDATE);
...
INSERT INTO MEMBER2 VALUES('MEM01', 'PASS01', '고길동', 01030286547);
